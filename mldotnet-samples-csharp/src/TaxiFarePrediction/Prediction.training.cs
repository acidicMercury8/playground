...
public partial class Prediction {
    ...
    /// For more information on how to load data, see aka.ms/loaddata
    /// </summary>
    ...
    public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext) {
        ...
        var pipeline = mlContext.Transforms.Categorical
            ...
            .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options() {
                ...
                LearningRate = 0.774631950681441,
                ...
                Booster = new GradientBooster.Options() {
                    ...
                    L2Regularization = 0.857638549563097
                },
                MaximumBinCountPerFeature = 479}));
        return pipeline;
    }
}
